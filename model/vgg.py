...
cfg = {
    'D_dropout': [64,0.3, 64, 'M', 128,0.4, 128, 'M', 256,0.4, 256,0.4, 256, 'M', 512,0.4, 512,0.4, 512, 'M', 512,0.4, 512,0.4, 512, 'M',0.5],
...
def vgg16_bn(dropout=True, **kwargs):
    """VGG 16-layer model (configuration "D") with batch normalization"""
    if dropout:
        model = VGG(make_layers(cfg['D_dropout'], batch_norm=True), **kwargs)
    else:
