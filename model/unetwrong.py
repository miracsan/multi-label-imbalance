#Buraya bir unet yazmışım ama bu uent değil, ne yapmışım bilmiyorum
...
class unet(nn.Module):
    ...
    def expand_block(self, in_channels, out_channels, kernel_size, padding):
        ...
        expand = nn.Sequential(
                            ...
                            nn.BatchNorm3d(out_channels),
                            nn.ReLU(),
                            nn.ConvTranspose3d(out_channels, out_channels, kernel_size=3, stride=2, padding=1, output_padding=1) 
                            )
        return expand